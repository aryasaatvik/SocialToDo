...
class TodoController:NSObject,UITableViewDataSource {
    ...
    var currentTodo: TodoList = TodoList(listItems:("Task One",false),("Task Two", true))
    override init(){
        super.init()
